		...
		<div class="container-fluid main-content">
			<div class="widget-container fluid-height clearfix mwi1200">
				<div class="heading clearfix">
					<i class="icon-reorder"></i> 新建学生信息 <a href="javascript:;"
				...
				<div class="widget-content padded clearfix">
					<form id="w0" class="form-horizontal">
						<div class="form-group field-customer-owner_name">
							<label class="control-label col-sm-2" for="customer-owner_name">学生姓名</label>

							<div class="col-sm-8">
								<input type="text" id="PRINPICAL" class="form-control">
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						<div class="form-group field-customer-customer_name required">
							<label class="control-label col-sm-2"
								for="customer-customer_name">学校名称</label>

							<div class="col-sm-8">
								<input type="text" id="CUSTOMERNAME" class="form-control"
									name="CUSTOMERNAME" placeholder="学校名称">
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						<div class="form-group field-customer-customer_zipcode required">
							<label class="control-label col-sm-2"
								for="customer-customer_zipcode">班级名称</label>

							<div class="col-sm-8">
								<input type="text" id="POST_CODE" class="form-control"
									name="POST_CODE" maxlength="6" placeholder="班级名称">
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						<div class="form-group field-customer-customer_industry required">
							...
							<div class="col-sm-8">
								<select id="FIELD_ID" class="form-control" name="FIELD_ID">
									...
									<c:forEach items="${workingfieldlist}" var="workingfieldlistss">
