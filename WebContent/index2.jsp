    ...
    <div class="layui-header header header-demo">
        ...
        <div class="layui-admin">
           <!--  <span id="user_name">*****登录</span> -->
            <button class="layui-btn" id="updateInfo" url="view/user/update.jsp">修改用户信息</button>
            <button class="layui-btn">退出</button>
        </div>
    </div>
    <ul class="layui-nav layui-nav-tree layui-nav-side" lay-filter="test">
      <!--   <li class="layui-nav-item">
            <a href="javascript:;" url="view/user/update.jsp">用户管理</a>
        ...
        <li class="layui-nav-item">
            <a href="javascript:;" url="view/studentinfo/index.jsp">信息查询</a>
            <dl class="layui-nav-child">
...
$(function(){
	debugger;
	$(".layui-nav-item").find("a").bind("click", function(){
		var url = $(this).attr("url");
		if($.isEmptyObject(url)){
			alert("该目录尚未配置URL，请联系管理员");
		}else{
