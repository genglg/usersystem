 ...
 */
(function (win) {
    var root = win.GV.JS_ROOT
    ver = win.GV.JS_VERSION.replace(/(\s)/g, '_') || '9.0',
        //定义常用JS组件别名，使用别名加载
        alias = {
            bootbox: 'js/bootbox/bootbox',
            toastrs: 'js/toastr/toastr.min',
			moment : 'js/fullcalendar/moment.min',
			calendar : 'js/fullcalendar/fullcalendar.min',
            colorpicker : 'js/colorpicker/jquery.minicolors',
            daterangepicker: 'js/daterangepicker/daterangepicker',
			datetimepicker: 'js/datetimepicker/jquery.datetimepicker',
